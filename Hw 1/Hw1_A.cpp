...
int main ()           // a function called main: it is the starting point of the program.
{
    ...
    cout << endl;
    cout << "    My name is Joshua Gomes." << endl << endl;
    cout << "    I am taking 22A because I'd like to build a solid foundation in Object Oriented Programming." << endl;
    cout << "    My main goal is to build something to change the world for the better." << endl << endl;
    cout << "===============================================" << endl;
...
/**~*~*
 ...
 My name is Joshua Gomes.
 
 I am taking 22A because I'd like to build a solid foundation in Object Oriented Programming.
 My main goal is to build something to change the world for the better.
